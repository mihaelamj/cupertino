...
let deps: [Package.Dependency] = [
    ...
    // types, Foundation-only, zero-dep). Local path during the extraction;
    // swapped for the versioned URL (from: "0.1.0") once it is published + tagged.
    .package(path: "../../CupertinoDataKit"),
]
