...
| `Core` | Foundation, LoggingModels, Resources, ASTIndexer, CoreProtocols, CorePackageIndexingModels, SharedConstants | ✅ ASTIndexer, CorePackageIndexingModels, CoreProtocols, Foundation, LoggingModels, Resources, SharedConstants (#904: WebKit dropped. The pre-#904 `import WebKit` on `Core.Parser.HTML` was dead; no WebKit symbols were used.) |
