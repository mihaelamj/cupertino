...
Per-source SQLite FTS5 database for Swift.org. One of the eight per-source databases produced by the v1.3.0 split of the former unified `search.db` ([#1036](https://github.com/mihaelamj/cupertino/issues/1036)).
