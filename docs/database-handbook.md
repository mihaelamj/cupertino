...
Remaining classes per the design's §14.2 priority order: C (acronym), G (prose), H (symbol-attribute) — not yet baselined. Plus §14.4 Phase 1.7 agent-end-to-end eval.
