...
- **2026-05-22 v3 (post-PR-#908 numeric refresh)**. PR #908 (the pre-flight hygiene §7.1 PRs 0a + 0b) landed. Stale MEASURED claims in §3.1 / §3.2 / §3.3 / §4.3 / §4.4 reflect the pre-#908 state and are inaccurate after merge. Specifically: §3.1 count "28 producer targets" is now 30; §3.1 prose breakdown "11 `*Models` foundation-only seam targets + 17 producer-or-infrastructure targets" is now 12 + 18 (AppleConstraintsKit + EnrichmentModels were opted into STRICT_PRODUCERS); §3.3 welded-backend audit "8 of 28 producers (29%)" is now 8 of 30 (DERIVED ratio rerun: 8/30 ≈ 27%; the 7-actual-gap-producers list is unchanged because #908 did not extract any concrete backend); §4.3 "1 real violation" is now 0; §4.4 claim "doc currently asserts Search imports do not include EnrichmentModels" is now false. Re-run any specific measurement before citing.
