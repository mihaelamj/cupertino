...
| Value | Behaviour |
|---|---|
| `auto` | (default) JSON API primary, with two augmentation paths: WKWebView fallback when JSON 404s, plus HTML link augmentation on sparse-references pages (v1.0.3+, [#203](https://github.com/mihaelamj/cupertino/issues/203)) |
...
## Configuration-file fields (v1.0.3+)
