...
flowchart TB
  ...
  subgraph Partial["Partial"]
    direction TB
    E1261["#1261 data engine extraction"]:::partial ~~~ E1036["#1036 per-source DB split (#1061 left)"]:::partial ~~~ E191["#191 search quality and FTS"]:::partial
  end
